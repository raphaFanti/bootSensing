...
const int DOUT1 = 5; //strain gauge 1 4A
const int CLK1 = 6; //strain gauge 1 4A

const int DOUT2 = 9; //strain gauge 2 4B
const int CLK2 = 10; //strain gauge 2 4B

//const int DOUT3 = 11; //strain gauge 3 data LOAD CELL
//const int CLK3 = 12; //strain gauge 3 clock LOAD CELL
